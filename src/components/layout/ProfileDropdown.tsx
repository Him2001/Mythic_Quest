        ...
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-amber-200 z-50 overflow-hidden">
          ...
          <div className="p-4 bg-gradient-to-r from-amber-50 to-yellow-50 border-b border-amber-200">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600 font-merriweather mt-1">
                  {user.email}
                </p>
              </div>
            </div>
          ...
          <div className="py-2">
            <button
              ...
              className="w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors duration-200 flex items-center space-x-3 text-gray-700"
            >
